...
const InitialStep = ({stepNumber, stepName, color, place, description}: InitialStepProps) => {
    return (
        <div className={`flex ${place === 'r' ? 'flex-row' : 'flex-row-reverse'} items-center mb-[5vh] ml-[3vh] mr-[3vh]`}>
            ...
            <div className={`order-1 ${place === 'r' ? 'ml-[3vh]' : 'mr-[3vh]' } pl-16 pr-16 text-2xl text-justify ${libreBaskerville.className}`}>
                {description}
            </div>
        </div>
    )
        ...
        <div className="flex flex-col mt-[6%]">
            <div className='flex flex-col items-center'>
                ...
                <div className={`mt-[6vh] ${libreBaskerville.className}`}>
                    ...
                    Refer to the FAQs page for a response on how to choose the best plan according to your needs and lifestyle.' />
